      ...
      <div class="col-md-6">
          ...
          <section class="page-content" id="content">
            {block name='page_content'}
              ...
              {block name='product_cover_thumbnails'}
                {include file='parent:catalog/_partials/product-cover-thumbnails.tpl'}
              {/block}
        ...
        <div class="col-md-6">
          ...
          {block name='product_prices'}
            {include file='parent:catalog/_partials/product-prices.tpl'}
          {/block}
          <div class="product-information">
            ...
            {if $product.is_customizable && count($product.customizations.fields)}
              {block name='product_customization'}
                {include file="parent:catalog/_partials/product-customization.tpl" customizations=$product.customizations}
              {/block}
            {/if}
              ...
              {block name='product_buy'}
                <form action="{$urls.pages.cart}" method="post" id="add-to-cart-or-refresh">
                  ...
                  {block name='product_variants'}
                    {include file='parent:catalog/_partials/product-variants.tpl'}
                  {/block}
                      ...
                      <section class="product-pack">
                        ...
                        {foreach from=$packItems item="product_pack"}
                          {block name='product_miniature'}
                            {include file='parent:catalog/_partials/miniatures/pack-product.tpl' product=$product_pack}
                          {/block}
                        {/foreach}
                    </section>
                    {/if}
                  ...
                  {block name='product_discounts'}
                    {include file='parent:catalog/_partials/product-discounts.tpl'}
                  {/block}
...
{******* CUSTOM COLUMN (Descripcion + ventajas + info addicional)************}  
      <div class="col-md-12">
        ...
        {***END Descripcion producto***}
            ...
            {/block}
        {** (Se ha movido mas arriba)    {block name='product_additional_info'}
                {include file='catalog/_partials/product-additional-info.tpl'}
            {/block} **}
      </div>
{******* END CUSTOM COLUMN ******}
