      ...
      <div class="col-md-12">
        <p class="text-sm-left">
          ...
          {/block}
            ...
            <span> | </span>
            <a href="{$urls.base_url}terminos-y-condiciones-de-uso_3">T�rminos y condiciones</a>
            <span> | </span>
            <a href="{$urls.base_url}pago-seguro_5">Pago seguro</a>
            <span> | </span>
            <a href="{$urls.base_url}politica-de-cookies_7">Pol�tica de cookies</a>
            <span> | </span>
            <a href="{$urls.base_url}politica-de-privacidad_8">Pol�tica de privacidad</a>
            <span> | </span>
