		...
		<div class="kr_blog_post_inner blog_style_{$xipblogsettings.blog_style} column_{$xipblogsettings.blog_no_of_col}">
			{foreach from=$xipblogpost item=xpblgpst}
				<article id="blog_post" class="blog_post blog_post_{$xpblgpst.post_format} clearfix">
					<a href="{$xpblgpst.link}" title="{$xpblgpst.post_title}" class="overlayer"></a>
					<div class="blog_post_content">
						<div class="blog_post_content_top">
							<div class="post_thumbnail overlap">
							{block name="xipblog_post_thumbnail"}
								...
								{else}
									<a href="{$xpblgpst.link}" title="{$xpblgpst.post_title}">    
						...
						<div class="blog_post_content_bottom">
							<h3 class="post_title">
								<a href="{$xpblgpst.link}" class="overlap">{$xpblgpst.post_title}</a>
							</h3>
							...
							<div class="post_meta clearfix">
								...
								<div class="meta_category">
									...
									<a href="{$xpblgpst.category_default_arr.link}" class="overlap">{$xpblgpst.category_default_arr.name}</a>
								</div>
							...
							<div class="content_more">
								<a class="read_more overlap" href="{$xpblgpst.link}">{l s='Continue' mod='xipblog'}
