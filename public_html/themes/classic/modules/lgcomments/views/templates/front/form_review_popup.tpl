...
<div id="form_review_popup" style="display: none;">
    ...
    {else}
        ...
        <div class="form-block star-rating">
            ...
            <img style="width:{$starsize|escape:'htmlall':'UTF-8'}px"
                 src="{$modules_dir|escape:'htmlall':'UTF-8'}views/img/stars/{$starstyle|escape:'htmlall':'UTF-8'}/{$starcolor|escape:'htmlall':'UTF-8'}/10stars.png"
                 id="lg_stars"
                 alt="rating">
        </div>
        <div class="form-block">
