...
class BlockWishListMyWishListModuleFrontController extends ModuleFrontController
{
	...
	public function assign()
	{
		...
		if ($this->context->customer->isLogged())
		{
			...
			$products = WishList::getProductByIdCustomer((int)$id_wishlist, $this->context->customer->id, $this->context->language->id);

			// $products = WishList::getProductByIdCustomer($id_wishlist, $this->context->customer->id, $this->context->language->id);
			...
			$this->context->smarty->assign(
				array(
					...
					'wish_url'=> $this->context->link->getModuleLink('blockwishlist', 'view', array('token' => $wishlist->token))
				)
			);
		}
		else
